...
<html>
    ...
    <!-- Content Wrapper. Contains page content -->
        ...
        {{-- Se carga la librería pero ninguna vista que use este layout tiene actualmente un carrusel Swiper activo (el único real está en home/home.blade.php, que usa layouts.app, no este). --}}
        <!-- Swiper js -->
