...
{{-- @if(isset($datosSituacion) && (count($datosSituacion['muni']) > 0)) --}}
    <section id="secciones-archivos">
        <main  class="margen-top-navbar">
                    ...
                    <nav class="navbar navbar-light bg-light col-lg-6 mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-select" aria-label="Default select example" name="anio">
                                ...
                                @foreach($datosSituacion['anios'] as $anioFiltro)

                                @if($anioFiltro != $datosSituacion['anio'])
                                    <option value="{{$anioFiltro}}">{{$anioFiltro}}</option>
                                    @endif
            ...
            {{--1. REPORTES ECONOMICO FINANCIERO--}}
            <div class="container mb-5" data-aos="fade-up">
                        ...
                        <div class="list-group">
                            <ul class="list-group text-center" >
                                ...
                                @if(isset($reportes['trimestre1']) && (count($reportes['trimestre1']) > 0))
                                    ...
                                    @endforeach
                                @else
                                <li class="list-group-item" style="color: #444444;"> No hay datos para el filtro aplicado </li>
                                @endif
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="list-group">
                            <ul class="list-group text-center" >
                                ...
                                @if(isset($reportes['trimestre2']) && (count($reportes['trimestre2']) > 0))
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="list-group">
                            <ul class="list-group text-center" >
                                ...
                                @if(isset($reportes['trimestre3']) && (count($reportes['trimestre3']) > 0))
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="list-group">
                            <ul class="list-group text-center" >
                                ...
                                @if(isset($reportes['trimestre4']) && (count($reportes['trimestre4']) > 0))
                    ...
                    <div class="list-group">
                        <ul class="list-group text-center" >
                            ...
                            @if(isset($datosSituacion['muni']) && (count($datosSituacion['muni']) > 0))
                                ...
                                @endforeach
                            @else
                                <span class="list-group-item" style="color: #444444;">No hay datos para el filtro aplicado</span>
                            @endif
                        </ul>
                    </div>
                </div>
