<nav id="fdt-navbar" class="navbar navbar-expand-lg navbar-dark navbar-bg-gr">
    <div class="container-fluid ">
        <a href="/56-fiesta-del-trigo" class="logo-fdt me-lg-0 font-color-bl"><img src="{{asset("storage/fdt/logo-fdt-bl.png")}}" alt="" class="img-fluid nv-logo"></a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <a class="yl-btn" href="https://play.google.com/store/apps/details?id=com.GDAMiTresa.Ciudadano" target="_blank">Tickets</a>
        </div>
        {{-- <form class="d-flex">
