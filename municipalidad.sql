...
--
-- Servidor: localhost
-- Tiempo de generación: 05-04-2024 a las 15:30:49
...
(1, 'Computos', NULL, '2023-11-28 17:25:10', NULL),
(2, 'Desarrollo social', NULL, '2023-11-28 17:25:17', NULL),
(3, 'Gestion ambiental', 'gestionambiental@tresarroyos.gov.ar', '2023-11-28 17:25:21', NULL),
(4, 'Mesa de entrada', NULL, '2023-11-28 17:25:23', NULL),
(5, 'Obras publicas - Planeamiento urbano', 'serviciospublicos@tresarroyos.gov.ar', '2023-11-28 17:25:26', NULL),
(6, 'Politicas tributarias', 'reclamos@tresarroyos.gov.ar', '2023-11-28 17:25:28', NULL),
(7, 'Prensa', 'prensa.hcd@tresarroyos.gov.ar', '2023-11-28 17:25:31', NULL),
(8, 'Produccion', NULL, '2023-11-28 17:25:33', NULL),
(9, 'Salud y prevencion', NULL, '2023-11-28 17:25:35', NULL),
(10, 'Seguridad', 'seguridad@tresarroyos.gov.ar', '2023-11-28 17:25:37', NULL),
(11, 'Secretaria de gobierno', NULL, '2023-11-28 17:25:40', NULL),
(12, 'Secretaría de hacienda', NULL, '2023-11-28 17:25:42', NULL),
...
(16, 'Cultura', 'cultura@tresarroyos.gov.ar', '2023-12-05 17:56:13', NULL),
(17, 'Turismo', 'turismo@tresarroyos.gov.ar', '2023-12-05 17:56:13', NULL),
(18, 'Cementerio', NULL, NULL, NULL),
(19, 'Compras y suministros', NULL, '2024-03-05 17:25:47', NULL),
(20, 'Catastro', NULL, '2024-03-05 17:25:47', NULL),
(21, 'Guías', NULL, '2024-03-05 17:25:47', NULL),
(22, 'Desarrollo Económico', NULL, '2024-03-05 17:25:47', NULL),
(23, 'Tesoreria', NULL, '2024-03-05 17:25:47', NULL),
(24, 'Delegación Municipal Copetonas', NULL, '2024-03-05 17:25:47', NULL),
(25, 'Obras Particulares - Planeamiento urbano', NULL, '2024-03-05 17:25:47', NULL);
...
CREATE TABLE `galeria` (
  `id` int(11) NOT NULL,
  `img` varchar(191) CHARACTER SET latin1 NOT NULL,
  `seccion_informacion_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `galeria` (`id`, `img`, `seccion_informacion_id`) VALUES
(2, 'biblio2.jpg', 12),
(3, 'biblio4.jpg', 12),
(4, 'siria.jpg', 5),
(5, 'holandesa.jpg', 5),
...
--
-- Estructura de tabla para la tabla `galeria_portada`
--

CREATE TABLE `galeria_portada` (
  `id` int(11) NOT NULL,
  `img` varchar(191) CHARACTER SET latin1 NOT NULL,
  `seccion_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Volcado de datos para la tabla `galeria_portada`
--
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Se registran todas las instituciones educativas de nivel Terciario y Universitario que hay en Tres Arroyos';
...
--
-- Estructura de tabla para la tabla `institucion_educativa_nivel`
--

CREATE TABLE `institucion_educativa_nivel` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `institucion_educativa_nivel`
--
...
--
-- Estructura de tabla para la tabla `menu_seccion`
--

CREATE TABLE `menu_seccion` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `menu_seccion`
--

INSERT INTO `menu_seccion` (`id`, `nombre`, `path`, `visible`) VALUES
...
--
-- Estructura de tabla para la tabla `propuesta_academica`
--

CREATE TABLE `propuesta_academica` (
  `id` int(11) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Se cargan todas las ofertas academicas privadas y publicas para darle informacion a los estudiantes futuros';

--
-- Volcado de datos para la tabla `propuesta_academica`
--
...
INSERT INTO `seccion` (`id`, `nombre`, `link`, `pertenece_a`, `portada`) VALUES
...
--
-- Estructura de tabla para la tabla `seccion_informacion`
--

CREATE TABLE `seccion_informacion` (
  `id` int(11) NOT NULL,
  `seccion_id` int(11) NOT NULL,
...
(1, '$2y$10$Rq4cLhZzT16knATAhsppt.ZtrjRzC/CJQqJu/cpfmIULl9gJFJYCi', 'Member', NULL, NULL, 'martinl@tresarroyos.gov.ar', NULL, NULL, '2024-02-15 19:26:01', '2024-02-15 19:26:01'),
(2, '$2y$10$1zjeMPV9rIAk4hVVc8A8oezK9OtRbQL1WSPTxEZr4.xmlfT9j9Jra', 'Member', NULL, NULL, 'carohansen73@gmail.com', NULL, NULL, '2024-03-27 14:35:53', '2024-03-27 14:35:53');
...
ALTER TABLE `evento`
  ADD PRIMARY KEY (`id`),
  ADD KEY `evento_seccion_pagina_FK` (`seccion_id`);
...
ALTER TABLE `galeria`
  ADD PRIMARY KEY (`id`),
  ADD KEY `galeria_seccion_textos_FK` (`seccion_informacion_id`);

--
-- Indices de la tabla `galeria_portada`
--
ALTER TABLE `galeria_portada`
  ADD PRIMARY KEY (`id`),
  ADD KEY `galeria_portada_seccion_pagina_FK` (`seccion_id`);
...
--
-- Indices de la tabla `institucion_educativa_nivel`
--
ALTER TABLE `institucion_educativa_nivel`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `menu_seccion`
--
...
ALTER TABLE `noticias`
  ADD PRIMARY KEY (`id`),
  ADD KEY `noticias_users_FK` (`usuario_id`);
...
ALTER TABLE `noticia_categoria`
  ADD PRIMARY KEY (`id`),
  ADD KEY `noticia_categoria_categorias_FK` (`categoria_id`),
  ADD KEY `noticia_categoria_noticias_FK` (`noticia_id`);
...
ALTER TABLE `noticia_img`
  ADD PRIMARY KEY (`id`),
  ADD KEY `noticia_img_noticias_FK` (`noticia_id`);
...
--
-- Indices de la tabla `propuesta_academica`
--
ALTER TABLE `propuesta_academica`
  ADD PRIMARY KEY (`id`),
  ADD KEY `propuesta_academica_institucion_educativa_FK` (`institucion_educativa_id`);
...
ALTER TABLE `seccion`
  ADD PRIMARY KEY (`id`),
  ADD KEY `seccion_pagina_seccion_menu_FK` (`pertenece_a`);

--
-- Indices de la tabla `seccion_informacion`
--
ALTER TABLE `seccion_informacion`
  ADD PRIMARY KEY (`id`),
  ADD KEY `seccion_textos_seccion_pagina_FK` (`seccion_id`);
...
--
-- AUTO_INCREMENT de la tabla `galeria_portada`
--
ALTER TABLE `galeria_portada`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
-- AUTO_INCREMENT de la tabla `institucion_educativa_nivel`
--
ALTER TABLE `institucion_educativa_nivel`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `menu_seccion`
--
ALTER TABLE `menu_seccion`
...
--
-- AUTO_INCREMENT de la tabla `noticia_categoria`
--
ALTER TABLE `noticia_categoria`
...
--
-- AUTO_INCREMENT de la tabla `propuesta_academica`
--
ALTER TABLE `propuesta_academica`
...
--
-- AUTO_INCREMENT de la tabla `seccion_informacion`
--
ALTER TABLE `seccion_informacion`
...
--
ALTER TABLE `evento`
  ADD CONSTRAINT `evento_seccion_pagina_FK` FOREIGN KEY (`seccion_id`) REFERENCES `seccion` (`id`);

--
-- Filtros para la tabla `galeria`
--
ALTER TABLE `galeria`
  ADD CONSTRAINT `galeria_seccion_textos_FK` FOREIGN KEY (`seccion_informacion_id`) REFERENCES `seccion_informacion` (`id`);

--
-- Filtros para la tabla `galeria_portada`
--
ALTER TABLE `galeria_portada`
  ADD CONSTRAINT `galeria_portada_seccion_pagina_FK` FOREIGN KEY (`seccion_id`) REFERENCES `seccion` (`id`);

--
-- Filtros para la tabla `institucion_educativa`
--
ALTER TABLE `institucion_educativa`
  ADD CONSTRAINT `institucion_educativa_institucion_educativa_nivel_FK` FOREIGN KEY (`nivel_id`) REFERENCES `institucion_educativa_nivel` (`id`);

--
-- Filtros para la tabla `noticias`
--
ALTER TABLE `noticias`
  ADD CONSTRAINT `noticias_users_FK` FOREIGN KEY (`usuario_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `noticia_categoria`
--
ALTER TABLE `noticia_categoria`
  ADD CONSTRAINT `noticia_categoria_categorias_FK` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `noticia_categoria_noticias_FK` FOREIGN KEY (`noticia_id`) REFERENCES `noticias` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `noticia_img`
--
ALTER TABLE `noticia_img`
  ADD CONSTRAINT `noticia_img_noticias_FK` FOREIGN KEY (`noticia_id`) REFERENCES `noticias` (`id`);

--
-- Filtros para la tabla `propuesta_academica`
--
ALTER TABLE `propuesta_academica`
  ADD CONSTRAINT `propuesta_academica_institucion_educativa_FK` FOREIGN KEY (`institucion_educativa_id`) REFERENCES `institucion_educativa` (`id`);
...
--
ALTER TABLE `seccion`
  ADD CONSTRAINT `seccion_pagina_seccion_menu_FK` FOREIGN KEY (`pertenece_a`) REFERENCES `menu_seccion` (`id`);

--
-- Filtros para la tabla `seccion_informacion`
--
ALTER TABLE `seccion_informacion`
  ADD CONSTRAINT `seccion_textos_seccion_pagina_FK` FOREIGN KEY (`seccion_id`) REFERENCES `seccion` (`id`);
